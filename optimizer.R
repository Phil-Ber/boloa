...
write.csv(edf, "/exports/nas/berends.p/boloa/optimize_screen_7.csv", row.names=FALSE)
...
while (mean(edf[,1]) >= 0.10 | tries < 100) {
  ...
  prev_add <- new_add
  write.table(new_add, file = "/exports/nas/berends.p/boloa/optimize_screen_7.csv", sep = ",", append = TRUE, quote = FALSE,
